...
const HomeDinning = () => {
  return (
    <div className="relative w-full min-h-screen bg-gray-100 dark:bg-gray-300">
      {/* Background Image */}
      ...
      {/* Content */}
      <div className="relative z-10 flex flex-col lg:flex-row justify-end items-center min-h-screen text-center lg:text-right gap-8">
        {/* Empty Space for Desktop */}
        <div className="hidden lg:block lg:w-1/2"></div>

        {/* Content Area */}
        <div className="lg:w-1/2 w-full min-h-screen bg-opacity-80 bg-[#793600] dark:bg-[#793600] flex flex-col gap-24 lg:gap-36 items-center justify-center text-center p-6 lg:p-16">
