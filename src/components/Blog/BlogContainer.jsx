...
import ShadcnButton from '../Atom/button/ShadcnButton';
  ...
  <div className={clsx(
    ...
    )}> <div className='w-full md:hidden flex justify-center'><ShadcnButton className="flex pointer md:hidden items-center justify-center tracking-wider bg-gradient-to-r from-[#c3965d] via-[#eabf91] to-[#c3965d] font-extrabold text-white font-bold p-3 px-6 rounded-xl  transition-colors duration-300 ease-in-out">
    Read more 
  </ShadcnButton></div>

      {/* Title and Description Section */}
      <div className="md:w-1/2 flex items-center just ify-center z-10">
