...
const Footer = () => {
  ...
  return (
    <footer className="dark:bg-[#00001F] bg-gray-50 text-black dark:text-white p-5 border-t-10 flex flex-col relative h-[80vh]">
        ...
        <div className="container mx-auto flex flex-col md:flex-row justify-center items-center gap-12 md:gap-16 px-0 py-12">
          ...
          <div className="text-center flex flex-col items-center md:w-1/4">
            ...
            <div className="flex justify-center items-center mt-1">
              {/* Social Icons (Placeholder for actual Social Components) */}
              <Socials />
              <SocialMobile />
            </div>
          </div>
      ...
      {/* Custom Theme Toggle Button - Left Side */}
      <div className="absolute bottom-8 left-8">
        <label className="inline-flex items-center relative">
          ...
          >
            <path d="M12,17c-2.76,0-5-2.24-5-5s2.24-5,5-5,5,2.24,5,5-2.24,5-5,5ZM13,0h-2V5h2V0Zm0,19h-2v5h2v-5ZM5,11H0v2H5v-2Zm19,0h5v2h-5v-2Zm-2.81-6.78l-1.41-1.41-3.54,3.54,1.41,1.41,3.54-3.54ZM7.76,17.66l-1.41-1.41-3.54,3.54,1.41,1.41,3.54-3.54Zm0-11.31l-3.54-3.54-1.41,1.41,3.54,3.54,1.41-1.41Zm13.44,13.44l-3.54-3.54-1.41,1.41,3.54,3.54,1.41-1.41Z"></path>
          </svg>
          <svg
            height="512"
            width="512"
