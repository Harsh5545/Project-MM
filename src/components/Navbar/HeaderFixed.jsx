...
function HeaderFixed() {
  ...
  return (
    <motion.div
      ...
      className="fixed z-[999]  bg-black overflow-x-hidden bg-opacity-65 nav top-2 left-1/2 border-none -translate-x-1/2 rounded-xl p-2 md:px-10 flex flex-col md:flex-row items-center justify-between"
      style={{ width: "90%" }}
    >
